  ...
  >
    ...
    >
      <g clip-path="url(#clip0)">
        ...
        >
          <path
            d="M0.852417 -6H40.0655L31.1147 28.2857H0.852417V-6Z"
            fill="#C4C4C4"
          />
        </mask>
        <g mask="url(#mask1)">
      ...
      <g clip-path="url(#clip1)">
        ...
        >
          <path
            d="M52.8524 43.7144H-2.55742L8.19098 9.42864H52.8524V43.7144Z"
            fill="#C4C4C4"
          />
        </mask>
        <g mask="url(#mask2)">
    ...
    <g mask="url(#mask0)">
      <rect width="52" height="36" fill="#1F2529" />
    </g>
    <defs>
      <pattern
        id="pattern0"
      ...
      >
        <use
          xlinkHref="#image0"
          transform="translate(-0.00274724) scale(0.00785543 0.0192308)"
        />
      </pattern>
      <pattern
        id="pattern1"
      ...
      <clipPath id="clip0">
        <rect width="36.6557" height="13.7143" fill="white" />
      </clipPath>
      <clipPath id="clip1">
        <rect
          width="52"
